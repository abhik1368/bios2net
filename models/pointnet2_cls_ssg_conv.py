...
def get_model(point_cloud, is_training, n_classes, bn_decay=None, weight_decay=None, **kwargs):
    ...
    l1_xyz, l1_points, l1_indices, pt_ker = pointnet_sa_module(l0_xyz, l0_points, npoint=256, radius=0.2, nsample=64, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, inception=inception, bn_decay=bn_decay, scope='layer1', use_nchw=True)
