...
def get_model(point_cloud, is_training, n_classes, bn_decay=None, inception=False, weight_decay=None, knn=False):
    ...
    l1_xyz, l1_points, l1_indices, kernel = pointnet_sa_module(l0_xyz, l0_points, npoint=256, radius=0.2, nsample=64, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1', knn=knn, use_nchw=True)
